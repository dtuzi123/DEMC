...
class LifeLone_MNIST(object):
    ...
    def train(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            reco6, recoLoss6,realBatch = self.Calculate_Student_RecoLoss(self.cifar_test_x)
            print(recoLoss6)
            ...
            print("IS score")
            is1 = self.Calculate_IS_Results(self.cifar_test_x)
            print(is1)
            ...
            for i in range(self.componentCount):
                ...
                newGan = newGan * 255.0
                newGan = np.reshape(newGan, (-1, 32, 32, 3))
                str2 = "TT__Final_CIFAR10_" + str(i) + ".png"
                cv2.imwrite(os.path.join("results/", str2),
                            merge2(newGan[:64], [8, 8]))
